(function () {
  ...
  var myCarousel = (function() {
    ...
    function init(set) {
      ...
      ctrls.innerHTML = '<li>' +
      '<button type="button" class="btn-prev"><img src="img/icon/triangle-left.png" alt="Previous"></button>' +
      '</li>' +
      '<li>' +
      '<button type="button" class="btn-next"><img src="img/icon/triangle-right.png" alt="Next"></button>' +
      '</li>';
